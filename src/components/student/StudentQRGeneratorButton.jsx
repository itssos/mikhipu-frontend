...
export default function StudentQRGeneratorButton({ id }) {
  ...
  return (
    <div className="flex flex-col justify-center items-center">
      {/* El botón ya no debe envolver el QR, sino solo el texto */}
      <div>
        {/* QR CANVAS: visualmente pequeño pero canvas grande */}
        <QRCodeCanvas
          value={String(id)}
          size={256} // El canvas SIEMPRE mide 256px para la descarga
          includeMargin={true}
          ref={qrCanvasRef}
          className=""
      ...
      <button
        onClick={downloadQR}
        className="w-7 h-7 font-bold rounded-md shadow-sm shadow-black transition-all hover:cursor-pointer hover:scale-115"
      >
        <svg viewBox="0 0 24 24" fill="none" width={22} className="mx-auto">
